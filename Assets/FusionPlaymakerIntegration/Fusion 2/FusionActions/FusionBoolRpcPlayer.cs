...
namespace GooglyEyesGames.PlayMaker.Fusion
{
	...
	public class FusionBoolRpcPlayer : FsmStateAction
	{
		[RequiredField]
        ...
        {
            PlaymakerFusionNetworkRunner.PFNR.rpcHandler.TargetPlayer(playerNumber.Value, remoteEvent.Name, boolData.Value);
