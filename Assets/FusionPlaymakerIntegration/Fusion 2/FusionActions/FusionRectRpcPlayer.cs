...
namespace GooglyEyesGames.PlayMaker.Fusion
{
	...
	public class FusionRectRpcPlayer : FsmStateAction
	{
		[RequiredField]
		...
		{
			PlaymakerFusionNetworkRunner.PFNR.rpcHandler.TargetPlayer(playerNumber.Value, remoteEvent.Name, rectData.Value);
