...
namespace GooglyEyesGames.PlayMaker.Fusion
{
	...
	public class FusionColorRpcPlayer : FsmStateAction
	{
		[RequiredField]
		...
		{
			PlaymakerFusionNetworkRunner.PFNR.rpcHandler.TargetPlayer(playerNumber.Value, remoteEvent.Name, colorData.Value);
